...
# -----------------------------------------------------------------------------
# $begin fewer_rows.R$$ $newlinech #$$
# $spell
#	optimality
# $$
#
# $section Example With Fewer Rows than Possible in Data Files$$
#
# $head Source Code$$
# $srcfile%example/student_college/fewer_rows.R%0# %# BEGIN R%# END R%1%$$
#
# $end
# BEGIN R
# ---------------------------------------------------------------------------
...
#
if( ok )
{	message("fewer_rows: OK")
} else {
	stop("fewer_rows: Error")
}
# END R
